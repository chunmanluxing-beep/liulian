...
CITIES = [
 ...
 ("nailiang", "奈良", "Nara", ["Nara"],
  ...
  "Photographs with the deer are the classic Nara picture; early mornings are calm and uncrowded. The approach to Todai-ji and the stone lanterns of Kasuga Taisha suit kimono sessions well."),
 ...
 ("yidou", "伊豆半岛", "Izu Peninsula", ["Shizuoka"],
  ...
  "Coastal work centres on Jogasaki and the sunsets of western Izu; the Kawazu blossom season suits portraits among the trees. Distances are long, so sessions are grouped by side of the peninsula."),
 ...
 ("liancang", "镰仓", "Kamakura", ["Kanagawa"],
  ...
  "Kamakura was once the seat of Japan's first warrior government. The Great Buddha of Kotoku-in and Tsurugaoka Hachimangu are its landmark sites, and the Enoden line runs along the shore past the well-known seaside crossing near Kamakurakokomae.",
...
TYPES = [
 ("xingtai-hefu", "和服旅拍", "Kimono sessions",
  ...
  "Set in historic districts and temple grounds. Dressing and hair styling are completed on the day before the session moves outdoors along a planned walking route. A natural choice for first-time visitors who want portraits in traditional dress."),
 ...
 ("xingtai-hunsha", "婚纱", "Wedding portraits",
  ...
  "Available in both Western dress and traditional wasou, set in gardens, along the coast, in old streets or against the mountains. Dress, location and timing are settled beforehand; the day itself follows the agreed route."),
...
T = {
 "zh": {
   ...
   "cta1": "在 GetYourGuide 预订", "cta2": "邮件咨询",
   ...
   "s5_h": "关于流涟",
   "about_p": "流涟旅拍创立于 2018 年,合作摄影师 200 余名,遍布全日本。业务涵盖和服旅拍、家庭常服、婚纱与会议活动摄影,拍摄地覆盖京都、东京、大阪等 10 个城市与地区。预订与咨询通过 GetYourGuide、Viator、小红书及邮箱进行。",
   "about": [("2018", "年创立"), ("200 余", "名合作摄影师,遍布全日本"), ("10", "个城市与地区")],
   "s6_h": "预订与联系", "s6_p": "预订通过店铺页面进行,其他事项可发送邮件。",
   "email_label": "邮箱", "email_sub": "咨询与合作",
   "foot_c": "© 流涟旅拍", "foot_n": "作品照片均经客人授权后展示。",
   "credits_link": "图片来源",
   "ph_photo": "图片位", "swipe": "◀ 左右滑动 ▶",
   ...
   "contacts": [("gyg", "GetYourGuide", "预订与档期"), ("viator", "Viator", "预订与档期"),
                ("xhs", "小红书", "作品与近况")],
 },
 "en": {
   ...
   "cta1": "Book on GetYourGuide", "cta2": "Email us",
   "s2_h": "Work", "s2_p": "Arranged by location. Click any image to view.",
   "ph_note": "Sample images · client work being added",
   "s3_h": "Where we shoot", "s3_p": "Ten cities and regions. Click a place for details and photographs.",
   "map_lg": "Map data: Natural Earth (public domain). Click a name or region for details.",
   "s4_h": "Services", "s4_p": "Four kinds of sessions, each carried out by local photographers.",
   "s5_h": "About Liulian",
   "about_p": "Liulian Photography was founded in 2018 and works with over two hundred partner photographers across Japan. Its services cover kimono, family, wedding and event photography, in ten cities and regions including Kyoto, Tokyo and Osaka. Bookings and enquiries are handled through GetYourGuide, Viator, Xiaohongshu and by email.",
   "about": [("2018", "founded"), ("200+", "partner photographers across Japan"), ("10", "cities and regions")],
   "s6_h": "Booking and contact", "s6_p": "Bookings go through the shop pages; for anything else, email works best.",
   "email_label": "Email", "email_sub": "Enquiries and partnerships",
   "foot_c": "© Liulian Photography", "foot_n": "Client photographs are shown with permission.",
   "credits_link": "Image credits",
   "ph_photo": "IMAGE SLOT", "swipe": "◀ swipe ▶",
   ...
   "contacts": [("gyg", "GetYourGuide", "Booking and dates"), ("viator", "Viator", "Booking and dates"),
                ("xhs", "Xiaohongshu", "Work and updates")],
 },
}
